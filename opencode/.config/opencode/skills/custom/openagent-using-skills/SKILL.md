...
**In OpenCode/Claude Code:** Use the `Skill` tool. When you invoke a skill, its content is loaded and presented to you—follow it directly. Never use the Read tool on skill files.
...
2. **Implementation skills second** (test-driven-development, executing-plans) - these guide execution
...
## Tool Mapping for OpenCode/OpenAgent
...
**OpenAgent custom skills are in:**
```
~/.config/opencode/skills/custom/
```

Use OpenCode's native `skill` tool to list and load skills.

## Available OpenAgent Skills

All skills use the `custom/openagent-*` naming pattern:
...
**Foundation (2 skills):**
- `custom/openagent-using-skills` (this skill)
- `custom/openagent-writing-skills`

## OpenAgent Philosophy

All OpenAgent skills integrate **approval gates** at phase transitions:
- Request approval before major operations
- Report results after operations complete
- Stop on failure, propose fixes, request approval

This ensures safety-first development while preserving proven methodologies.
